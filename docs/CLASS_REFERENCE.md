...
| 类 | 职责 |
| --- | --- |
| `org.espetro.api.EspetroAPI` | 对外阵营、小队、队长和指挥官查询 |
| `org.espetro.config.GameConfig` | `game.json` 加载与 getter，包括秒制体力参数 |
...
| `CommanderSkillType` | 指挥官技能类型 |
| `CommanderSkillManager` | 技能权限、效果和冷却 |
